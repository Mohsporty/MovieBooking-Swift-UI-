...
struct SeatsView: View {
    ...
    var body: some View {
        VStack(spacing: 0.0){
            ...
            // under the zstak all for color and animated for informations ticket in the 3 circle
            ...
            ZStack(alignment:.topLeading) {
                ...
                // this code for add the calendar by black color in the page and put by sections
